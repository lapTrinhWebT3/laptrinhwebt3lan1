...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
  ...
  <h3 style="color: blue"> Bài tập số 5</h3>
   <div style="margin-left:50px "> Nộp bài lập trình C <br></div> 
    <h3 style="color: blue">Tình Trạng</h3>
  <strong>Tình trạng nộp bài:</strong> chưa nộp <br>
  <strong>File nộp:</strong> <br>
  <strong>Hạn chót:</strong> 7h 20/7/2016 
