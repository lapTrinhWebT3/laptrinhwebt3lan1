...
<img src="picture\banner.jpg" width="1300px" height="150px" >
  ...
  <div class="container-fluid">
    ...
    <div id="left">
    <h4 align="center">CÁC CUỘC THI</h4>
    <ul class="list-group">
     <a href="#" class="list-group-item ">Đánh giá năng lực - Hóa học</a>
     <a href="#" class="list-group-item ">Đánh giá năng lực - Anh văn</a>
     <a href="#" class="list-group-item ">Đánh giá năng lực - Vật lý</a>
     <a href="#" class="list-group-item ">Đánh giá năng lực - C++</a>
     <a href="#" class="list-group-item ">Đánh giá năng lực - Toán A1 </a>
    </ul>
    ...
    <div id="content">
        <div class="course-detail" data-anchor="course-detail">
                <h2 class="course-detail-stitle">Mô tả khóa học</h2>
    ...
    <dl>
    <h2>Tuần 1:</h2>
    <dt><a href="laptrinhcc.jsp"><h3>Bài 1: Giới Thiệu Lập Trình C</h3></a></dt>
    <dd>- Giới thiêu về ngôn ngữ C </dd>
    <dd>- Các ví dụ đơn giản về C</dd>
    <h2>Tuần 2:</h2>
    <dt><a href="laptrinhcc"><h3>Bài 2: Phương Pháp Lập Trình</h3></a></dt>
    <dd>- Thuật Giải </dd>
    <dd>- Ngôn ngữ lập trình </dd>
    <dd>- Sử dụng Lưu đồ </dd>
    <dt><a href="laptrinhcc"><h3>Bài 3: Các thành phần trong C</h3></a></dt>
    <dd>- Từ Khóa</dd>
    <dd>- Kiểu dữ liệu</dd>
    <dd>- Khai báo biến</dd>
    <h2>Tuần 3:</h2>
    <dt><a href="laptrinhcc"><h3>Bài 4: Phương Pháp Lập Trình</h3></a></dt>
    <dd>- Thuật Giải </dd>
    <dd>- Ngôn ngữ lập trình </dd>
    <dd>- Sử dụng Lưu đồ </dd>
    <dt><a href="laptrinhcc"><h3>Bài 5: Thuật Giải</h3></a></dt>
    <dd>- Thuật Giải </dd>
    <dd>- Ngôn ngữ lập trình </dd>
    <dd>- Sử dụng Lưu đồ </dd>
    <h2>Tuần 4:</h2>
    <dt><a href="laptrinhcc"><h3>Bài 6: Chương Trình đơn giản</h3></a></dt>
    <dd>- Thuật Giải </dd>
    <dd>- Ngôn ngữ lập trình </dd>
    <dd>- Sử dụng Lưu đồ </dd>
  </dl>
