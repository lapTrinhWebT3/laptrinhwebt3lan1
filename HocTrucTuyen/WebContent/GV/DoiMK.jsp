...
<div id="left" style="border:0px">
    ...
    <a href="GV.jsp" class="list-group-item">
	 ...
	 <a href="DoiMK.jsp" class="list-group-item active">
...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
 <h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Đổi Mật Khẩu</h4>
 <form name="myForm">
	<div class="form-inline">
		<label class="fieldinput col-sm-3">Mật khẩu hiện tại: </label>
		<input type="password" name="pws1" id="MK1" class="form-control" onkeyup="checkPass()">
		<span id="z-MK1"></span>
	</div><br>
		<div class="form-inline">
		<label class="fieldinput col-sm-3">Mật khẩu mới: </label>
		<input type="password" name="pws2" id="MK2" class="form-control" maxlength="20" onkeyup="checkPass()">
		<span id="z-MK2"></span>
	</div><br>
		<div class="form-inline">
		<label class="fieldinput col-sm-3">Xác Nhận Mật Khẩu: </label>
		<input type="password" name="re_pws2" id="re_MK2" class="form-control" maxlength="20" onkeyup="password()">
		<span id="z-re_MK2"></span>
	</div><br>

	<div class="form-inline">
		<!--<button type="button" id="DMK">Đổi Mật Khẩu</button>-->
		<div type="submit" id="z-DMK"></div>
	</div>
</form>
 </div>
