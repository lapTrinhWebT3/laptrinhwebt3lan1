...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
 <h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Thêm Bài Tập</h4>
	...
	<div class="form-inline">
		<label class="fieldinput col-sm-3">Ngày Nộp: </label>
