...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
 <h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Nhập Kế Hoạch Học Tập</h4>
	<div class="form-inline">
		<label class="fieldinput col-sm-3">Thời Gian: </label>
		<input type="text" class="form-control">
	</div><br>
	<div class="form-inline">
		<label class="fieldinput col-sm-3">Mã Lớp: </label>
		<input type="text" class="form-control">
	</div><br>
	<div class="form-inline">
		<label class="fieldinput col-sm-3">Nội dung học: </label>
