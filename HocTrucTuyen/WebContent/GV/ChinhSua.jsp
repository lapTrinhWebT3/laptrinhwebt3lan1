...
<div id="left" style="border:0px">
    ...
    <a href="GV.jsp" class="list-group-item">
     ...
     <a href="ChinhSua.jsp" class="list-group-item active">
...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
 <h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Chỉnh Sửa Thông Tin Cá Nhân</h4>
  <img src="icon/user.png" alt="User Icon" width="80" height="80">
			<div class="form-inline">
		<label class="fieldinput col-sm-3">Họ Và Tên: </label>
	...
	<div class="form-inline">
		<label class="fieldinput col-sm-3">Email: </label>
		<input type="text" class="form-control">
	</div><p></p>
	<div class="form-inline">
