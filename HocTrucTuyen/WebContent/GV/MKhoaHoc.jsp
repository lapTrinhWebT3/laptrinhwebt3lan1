...
<div id="left" style="border:0px">
    <h4 align="center" style="background-color:#8258FA;color:white;line-height: 40px;font-size:17px">Control Panel</h4>
		...
		<a href="GV.jsp" class="list-group-item">
		 ...
		 <a href="MKhoaHoc.jsp" class="list-group-item active">
...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
	<h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Mở Khóa Học</h4>
	<form name="myForm">
		<div class="form-inline">
			<label class="fieldinput col-sm-3 ng-invalid ng-invalid-required ng-dirty ng-valid-parse">Tên Môn Học: </label>
			...
			<span ng-show="myForm.myName.$touched &amp;&amp; myForm.myName.$invalid" class="ng-hide">Tên môn học không được để trống!</span>
		</div><br>
		<div class="form-inline">
			<label class="fieldinput col-sm-3"> Thời gian bắt đầu: </label>
			<input type="date" class="form-control" id ="sday" min="1954-01-01" max="2050-12-31" onclick="checkDate()" onkeyup="checkDate()">
			<span id="z-sday"></span>
		</div><br>
		<div class="form-inline">
			<label class="fieldinput col-sm-3"> Thời gian kết thúc: </label>
			<input type="date" class="form-control"  id="eday"  min="1954-01-01" max="2050-12-31" onclick="checkDate()" onkeyup="checkDate()">
			<span id="z-eday"> </span>
		</div><br>
		<div class="form-inline">
			<label class="fieldinput col-sm-3"> Sĩ số: </label>
			<input type="text" class="form-control">
			
		</div><br>
		<div class="form-inline">
			<label class="fieldinput col-sm-3"> Lịch học: </label>
			<input type="text" class="form-control">		
		</div><br>
		<div class="form-inline">
			<label class="fieldinput col-sm-3"> Địa diểm: </label>
			<input type="text" class="form-control">
		</div><br>
		<div class="form-inline">
			<label class="fieldinput col-sm-3"> Mô tả khóa học: </label>
