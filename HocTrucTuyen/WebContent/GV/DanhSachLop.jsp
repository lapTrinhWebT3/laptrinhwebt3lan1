	...
	<div id="navbar">
      ...
      <li>
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="login.jsp"><span class="glyphicon glyphicon-log-out"></span>Đăng xuất</a></li>
				</ul>
			</div>
		</nav>
	</div>
			  ...
			  <table class="table" align="center">
				...
				<tbody>
					<tr>
						...
						<td>4/3/2017</td>
						<td>12:30, tại...</td>
						<td><a href="BaiTap.jsp">Xem bài tập</a></td>
						<td><a href="ChiTietDanhSach1.jsp">Xem chi tiết</a></td>
					</tr>
					<tr>
						<td>2 </td>
						<td>141102 </td>
						...
						<td>6:30, tại... </td>
						<td><a href="BaiTap.jsp">Xem bài tập</a></td>
						<td><a href="ChiTietDanhSach2.jsp">Xem chi tiết</a></td>
					</tr>					
				</tbody>
			  </table>
</div>
