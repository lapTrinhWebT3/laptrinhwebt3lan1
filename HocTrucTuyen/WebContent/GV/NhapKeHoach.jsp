...
<div id="left" style="border:0px">
	...
	<a href="NhapKeHoach.jsp" class="list-group-item active">
...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
 <h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Kế Hoạch</h4>
