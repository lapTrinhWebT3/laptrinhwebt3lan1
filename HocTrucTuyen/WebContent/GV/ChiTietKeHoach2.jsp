	...
	<div id="navbar">
      ...
      <li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="index/Home.html"><span class="glyphicon glyphicon-log-out"></span>Đăng xuất</a></li>
				</ul>
			</div>
		</nav>
	</div>
...
<div id="left" style="border:0px">
    ...
    <a href="GV.html" class="list-group-item">
      <span class=" glyphicon glyphicon-user"></span>Thông Tin Cá Nhân</a></a>
	  
     <a href="HopThu.html" class="list-group-item">
     <span class=" glyphicon glyphicon-comment"></span>Hộp Thư</a>
	 
     <a href="ChinhSuaThongTinGV.html" class="list-group-item">
     <span class="glyphicon glyphicon-pencil"></span>Chỉnh Sửa Thông Tin</a>
	 	 	 
	 <a href="DoiMK.html" class="list-group-item">
     <span class="glyphicon glyphicon-pencil"></span>Đổi Mật Khẩu</a>
	 
     <a href="MKhoaHoc.html" class="list-group-item">
     <span class="glyphicon glyphicon-plus"></span>Mở Khóa Học</a>
	 
	<a href="KeHoach.html" class="list-group-item active">
	<span class="#"></span>Kế Hoạch Học Tập</a>
	 
	 <a href="BaiTap.html" class="list-group-item ">
     <span class="#"></span>Bài Tập</a>
	 
	<a href="BTTracNghiem.html" class="list-group-item ">
     <span class="#"></span>Bài Tập Trắc Nghiệm</a>
	 
	 <a href="DanhSachLop.html" class="list-group-item ">
...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
 <h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Chi Tiết Kế Hoạch</h4>
