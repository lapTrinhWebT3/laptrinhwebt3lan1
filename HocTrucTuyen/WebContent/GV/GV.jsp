		...
		<nav class="navbar" >
			<div class="container-fluid col-12 col-lg-12">
					...
					<ul class="nav navbar-nav navbar" >
						...
						<li><a href="GV.jsp">Giảng Viên</a></li> 
...
<div id="left" style="border:0px">
    ...
    <a href="GV.jsp" class="list-group-item active">
...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
 <h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Thông Tin Cá Nhân</h4>
 <table class="table table-striped" style="font-size:15px">
    <thead>
    </thead>
	<tbody>
			<tr>
				<td><span><strong>Họ và Tên:</strong></span></td>
			</tr>
			<tr>
				<td><span><strong>Email:</strong></span></td>
			</tr>
			<tr>
				<td ><span><strong>Số Điện Thoại:</strong></span></td>
			</tr>
			<tr>
				<td><span><strong>Ngày Sinh:</strong></span></td>
			</tr>
			<tr>
				<td><span><strong>Địa Chỉ:</strong></span></td>
			</tr>
			<tr>
				<td><strong>Giảng Viên Môn:<strong></td>
			</tr>
			<tr>
				<td><span><strong>Hiện Đang Công Tác Tại:</strong></span></td>
			</tr>
	</tbody>
</table>
 </div>
