...
<div id="content" style="border:0px;margin-left:40px;width:1055px" >
 <h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Bài Tập Trắc Nghiệm</h4>
	<div class="btn-group">
		<button type="submit"><a href="ThemTracNghiem.jsp">Thêm Bài Tập</a></button>
		<button type="submit"><a href="BTTNDaNop.jsp">Bài Tập Đã Nộp</a></button>
	</div>
  <table class="table" align="center">
				...
				<tbody>
					<tr>
						...
						<td>10 phút</td>
						<td>10 câu</td>
						<td><a href="ChiTietBTTracNghiem1.jsp">Xem chi tiết</a></td>
					</tr>
					<tr>
						<td>2</td>
						<td>141101</td>
						<td>Điều kiện If...Else</td>
						<td>5 phút</td>
						<td>5 câu</td>
						<td><a href="ChiTietBTTracNghiem2.jsp">Xem chi tiết</a></td>
					</tr>
				</tbody>
			  </table>
 </div>
